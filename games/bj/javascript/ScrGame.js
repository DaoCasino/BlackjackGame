...
var ScrGame = function(){
	...
	_self.createBtn = function(){
		...
		var btnFullscreen = addButton("btnFullscreen", _W - 80, startY - offsetY*0);
		...
		var btnHistory = addButton("btnHistory", _W - 80, startY - offsetY*3);
